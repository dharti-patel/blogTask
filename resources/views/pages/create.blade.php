    ...
    <div class="">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" enctype="multipart/form-data" action="/saveBlog">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="body" class="form-control @error('body') is-invalid @enderror" rows="4" cols="50" name="body" required autocomplete="body" autofocus></textarea>
